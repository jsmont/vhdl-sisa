...
sisa-objdump -d test_vga_echo_keyboard.o > test_vga_echo_keyboard.code
...
#desensamblamos
sisa-objdump -x test_vga_echo_keyboard.o >test_vga_echo_keyboard.dis
sisa-objdump -d test_vga_echo_keyboard.o >>test_vga_echo_keyboard.dis
