...
sisa-gcc -g3 -c -Wall -Wextra -O2 fruit.c  -o fruit.o
sisa-gcc -g3 -c -Wall -Wextra -O2 main.c   -o main.o
sisa-gcc -g3 -c -Wall -Wextra -O2 nsnake.c -o nsnake.o
sisa-gcc -g3 -c -Wall -Wextra -O2 player.c -o player.o
sisa-gcc -g3 -c -Wall -Wextra -O2 engine.c -o engine.o -DVERSION=\""1.7"\"
...
sisa-objdump -d --section=.sistema temp_nsnake.o >nsnake.code
sisa-objdump -s --section=.sysdata temp_nsnake.o >nsnake.data
...
sisa-objdump -S -x --section=.sistema temp_nsnake.o >nsnake.dis
sisa-objdump -S -x --section=.sysdata temp_nsnake.o >>nsnake.dis
